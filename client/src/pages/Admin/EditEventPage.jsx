...
import { Calendar, MapPin, Upload, Trophy, Users, FileText, ArrowLeftIcon, SaveAll, SaveAllIcon, Trash, Trash2 } from "lucide-react";
...
export default function EditEventPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6">
            <button onClick={() => { navigate("/admin/events"); resetFormData() }} className='btn btn-ghost mb-8'>
                <ArrowLeftIcon className='size-4 mr-2' />
                Back to events page
            </button>
            <div className="card bg-base-100 shadow-xl border border-base-200">
                <div className="card-body">
                    <h2 className="card-title text-2xl font-bold text-primary">Edit Event</h2>
