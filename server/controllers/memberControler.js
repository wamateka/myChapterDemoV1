...
export const addMember = async (req,res) => {
    ...
    try{
        const newMember = await sql`
            INSERT INTO Members (nsbe_id, first_name, last_name, email, graduation_year, major, role, locals_dues, national_dues)
            VALUES (${nsbe_id}, ${first_name}, ${last_name}, ${email}, ${graduation_year}, ${major}, ${role}, ${locals_dues}, ${national_dues})
            RETURNING *;`;
